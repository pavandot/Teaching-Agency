...
const Courses = () => {
	...
	return (
		<section className='bg-customBlue relative'>
			<h1 className='text-center pt-20 pb-9 text-5xl font-bold' style={{ color: "#243141" }}>
			...
			<div className='mx-11 grid grid-cols-1 lg:grid-cols-3 gap-6'>
					...
					return (
						<div key={index}>
							<div className='relative rounded-2xl overflow-hidden courses-card'>
								...
								<div className='absolute z-30 top-56  text-white  flex flex-col justify-center w-full items-center px-5  '>
